...
var app = new Vue(
	{
		...
		{
			loadPrices: function () {
				fetch("https://raw.githubusercontent.com/supermarkt/checkjebon/main/data/supermarkets.json").then((response) => {
					...
					for (let i = 0; i < this.prices.length; i++) {
						...
						if (this.prices[i]['n'] == "janlinders") {
							this.prices.splice(i, 1)
						}
						if (this.prices[i]['n'] == "picnic") {
							this.prices.splice(i, 1)
						}
						if (this.prices[i]['n'] == "plus") {
							this.prices.splice(i, 1)
						}
						if (this.prices[i]['n'] == "spar") {
							this.prices.splice(i, 1)
						}
